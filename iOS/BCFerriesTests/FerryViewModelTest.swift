...
class FerryViewModelTest: XCTestCase {
    ...
    class FR: FerryRepository {
        let ferry = Ferry(time: .MIDNIGHT, from: .Tsawwassen, to: .SwartzBay, dur: 1, days: .MondayToSaturday, fare: "1.2", via: nil)
        var ferries: [Ferry] = []
    ...
    class HR: HolidayRepository {
        ...
        override func refresh(completion: @escaping () -> Void) { holidays.insert(newYear2020); completion() }
