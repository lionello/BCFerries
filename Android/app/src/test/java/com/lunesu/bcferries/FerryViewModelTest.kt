...
class FerryViewModelTest {
    ...
    private val ferryRepository = object : FerryRepository(db) {
        val ferry = Ferry(LocalTime.MIDNIGHT, FerryPier.Tsawwassen, FerryPier.SwartzBay, Duration.standardMinutes(1), FerryDay.MondayToSaturday, "1.2", null)
    ...
    fun testSwitchPier() = runBlockingTest {
        ...
        vm.switchPier(FerryPier.Tsawwassen)
        assertNotNull(state)
