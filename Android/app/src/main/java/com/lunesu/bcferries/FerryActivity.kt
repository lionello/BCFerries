...
import com.lunesu.bcferries.ui.ferry.FerryFragment
import com.lunesu.bcferries.ui.ferry.FerryViewModel
import com.lunesu.bcferries.ui.ferry.LocationViewModel
import com.lunesu.bcferries.ui.ferry.Strings
import java.util.*
...
class FerryActivity : AppCompatActivity() {
    ...
    override fun onPrepareOptionsMenu(menu: Menu?): Boolean {
        ...
        when (Locale.getDefault().language) {
            ...
            "fr" ->
                menu?.findItem(R.id.app_bar_fr)?.isChecked = true
        }
        ...
        return when (item.itemId) {
            ...
            R.id.app_bar_store -> {
                val intent = Intent(Intent.ACTION_VIEW).apply {
                    data = Uri.parse(Constants.storeUrl)
